...
Monaco 编辑器，支持文件树、语法高亮与 TypeScript 智能提示。

![代码编辑器](docs/demo/screenshots/code-editor.png)

### AI Agent 面板

多会话 AI 对话，支持工具调用、流式回复，与代码编辑并排显示。

![AI Agent 面板](docs/demo/screenshots/agent-panel.png)
